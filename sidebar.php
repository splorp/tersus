		...
		?>
			<li>
				...
				<ul>
					...
					<li>Valid <a href="https://validator.w3.org/nu/?doc=<?php echo bloginfo('url'); ?>" title="This page validates as HTML5"><abbr title="HyperText Markup Language">HTML5</abbr></a></li>
