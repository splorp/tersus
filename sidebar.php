		...
		?>
			<li>
				...
				<ul>
					...
					<li>Valid <a href="http://jigsaw.w3.org/css-validator/validator?uri=<?php echo esc_url(get_stylesheet_uri()); ?>" title="The stylesheet for this page validates as CSS"><abbr title="Cascading Style Sheets">CSS</abbr></a></li>
					<li>Valid <a href="http://validator.w3.org/feed/check.cgi?url=<?php esc_url(bloginfo('rss2_url')); ?>" title="The feed for this page validates as RSS"><abbr title="Really Simple Syndication">RSS</abbr></a></li>
